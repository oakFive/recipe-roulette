...
>>>>>>> a98e81ae888be232c9f78c52358f79db55eff18b
    ...
    },
    {
        ...
        instructions: [
            'Divide the  Red Bean Paste (3/4 cup)  into 8 pieces, roll into balls.',
            'Mix  Instant Dry Yeast, Granulated Sugar, and  Milk together, let it rest for 10 minutes.',
...
<<<<<<< HEAD
    ...
    },
    {
        ...
        ingredients: [
            ...
            '1 1/2 cups refried beans (or 1 1/2 cups drained and rinsed black beans)',
            '3/4cup corn kernels',
            '3 cups cooked rice',
...
>>>>>>> a98e81ae888be232c9f78c52358f79db55eff18b
        ...
        instructions: [
            ...
            'To prepare 1 burrito: spread 1/4 cup beans down center of tortillas; top with 1/2 cup rice, beef, 2 tablespoons corn, and 1/4 cup cheese.',
    ...
    },
    {
        ...
        instructions: [
            ...
            'Meanwhile, make slaw: In a large bowl, whisk together mayonnaise, lime juice, cilantro, and honey. Stir in cabbage, corn, and jalapeño. Season with salt and peppe',
    ...
    },
    {
        ...
        instructions: [
            'Simmer the cow feet and marrow bones in a large pot with 6 quarts of water, 4 garlic cloves and an onion for about 15 minutes at medium heat without covering',
            'During this time, skim off the foam that forms.',
            ...
            'Remove the cow feet and marrow bones from the pot. Skim the fat that forms on top of the broth',
            'Once the Cow foot cools a little, remove the bones and chop the meaty parts of to be returned to the pot.',
            'While the meat is cooking, prepare the guajillo sauce. Toast the Guajillo peppers in a griddle over medium heat.',
            'Press them down with a spatula slightly toasting them without burning them.',
            'Place the roasted peppers in a bowl and cover with water. Let them soak for about 25 minutes until soft.',
            'drain the peppers and place them in your blender with 3 garlic cloves, ½ cup of the broth, and cumin if using.',
            'Blend until very smooth. Strain the sauce using a sieve and pour into the pot. ',
            'Simmer the broth for another 30 minutes, partially covered. Taste to season with more salt if needed.',
...
},
{
    ...
    ingredients: [
        ...
        '1/4 tsp garlic powder, dried oregano, dried basil and pepper',
    ...
    },
    {
        ...
        instructions: [
            ...
            'In an extra-large skillet (with a lid), warm the oil over medium-high heat. Add in the onion and celery; saute until softened, stirring occasionally, about 3 minutes. Stir in the garlic and cook for 30-60 seconds until fragrant. Sprinkle with a touch of salt and peppe',
...
const vegetarianMealData = [
    {
        ...
        ingredients: [
            '1 ¾ cups chopped baby portobello',
            '1 medium onion, finely chopped',
            '½ cup chopped sun-dried tomatoes',
            '2 tablespoons olive oil',
            '2 garlic cloves, minced',
            '1 package frozen vegetarian meat crumbles',
            '2 cans chili beans',
    ...
    },
    {
        ...
        ingredients: [
            ...
            '1 1/2 pounds mushrooms (bella bella, cremini',
            'Garlic salt (to taste)',
            'Black pepper (to taste)',
            '1 1/2 tbsp fresh lemon juice (1/2 large lemon',
    ...
    instructions: [
        ...
        'Dress the lentils with half the dressing, then spoon onto the plates or serving platter. Arrange the crispy kale and squash on top, crumble over the goat cheese, and drizzle over a bit more dressing. Finally, top with the fried seeds, and crumble over the amaretti biscuits and crispy sage leaves.',
